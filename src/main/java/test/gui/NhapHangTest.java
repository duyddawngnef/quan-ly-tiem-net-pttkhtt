...
public class NhapHangTest extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/gui/view/nhapHang.fxml"));
            ...
            primaryStage.setTitle("Hệ thống Test - Quản lý Nhập Hàng");
