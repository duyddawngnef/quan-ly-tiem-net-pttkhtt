...
public class TestChuongTrinhKhuyenMaiDAO {
    ...
    private static void testThem() {
        ...
        try {
            ...
            ctkm.setMaCTKM(dao.taoMaChuongTrinhTuDong());
            ctkm.setTenCT("Khuyến mãi nạp thẻ tháng 1");
    ...
    private static void testCapNhat() {
        ...
        try {
            ChuongTrinhKhuyenMai ctkm = dao.timTheoMa("CTKM001");
            ...
            if (ctkm != null) {
                ...
                System.out.println("✗ Không tìm thấy chương trình CTKM001");
            }
        } catch (Exception e) {
            System.out.println("✗ Lỗi: " + e.getMessage());
            e.printStackTrace();
    ...
    // ===== TEST 18: CẬP NHẬT CHƯƠNG TRÌNH HẾT HẠN =====
