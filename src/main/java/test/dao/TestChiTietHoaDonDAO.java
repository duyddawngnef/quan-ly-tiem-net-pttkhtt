...
/**
 * Test class cho ChiTietHoaDonDAO
 * Test tất cả các chức năng CRUD và tính toán
 */
public class TestChiTietHoaDonDAO {
    ...
    private static void testThemNhieu() {
        ...
        try {
            ...
            ct1.setMaCTHD(dao.taoMaChiTietTuDong());
            ct1.setMaHD("HD002");
            ...
            ct2.setMaCTHD(dao.taoMaChiTietTuDong());
            ct2.setMaHD("HD002");
            ...
            ct3.setMaCTHD(dao.taoMaChiTietTuDong());
            ct3.setMaHD("HD002");
    ...
    private static void testCapNhat() {
        ...
        try {
            ChiTietHoaDon chiTiet = dao.timTheoMa("CTHD001");
            ...
            if (chiTiet != null) {
                ...
                System.out.println("✗ Không tìm thấy chi tiết CTHD001");
            }
        } catch (Exception e) {
            System.out.println("✗ Lỗi: " + e.getMessage());
            e.printStackTrace();
    ...
    // ===== TEST 14: LẤY CHI TIẾT VỚI HÓA ĐƠN =====
    ...
    // ===== TEST 18: XÓA THEO HÓA ĐƠN =====
    private static void testXoaTheoHoaDon() {
        System.out.println("--- Test 18: Xóa tất cả chi tiết của hóa đơn ---");
        try {
            // Tạo hóa đơn test
            String maHDTest = "HD_TEST_DELETE_ALL";

            // Thêm 2 chi tiết test
            ChiTietHoaDon ct1 = new ChiTietHoaDon();
            ct1.setMaCTHD("CTHD_TEST_1");
            ct1.setMaHD(maHDTest);
            ct1.setLoaiChiTiet("GIOCHOI");
            ct1.setMoTa("Test 1");
            ct1.setSoLuong(1.0);
            ct1.setDonGia(5000);
            ...
            ChiTietHoaDon ct2 = new ChiTietHoaDon();
            ct2.setMaCTHD("CTHD_TEST_2");
            ct2.setMaHD(maHDTest);
            ct2.setLoaiChiTiet("DICHVU");
            ct2.setMoTa("Test 2");
            ct2.setSoLuong(1.0);
            ct2.setDonGia(10000);
